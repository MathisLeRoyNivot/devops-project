	...
	public plcttData: ChartDataSets[] = [
		{
			...
			label: 'Automaton 1',
			backgroundColor: [ 'rgba(0, 149, 255, 0.6)', 'rgba(0, 149, 255, 0.6)', 'rgba(0, 149, 255, 0.6)', 'rgba(0, 149, 255, 0.6)', 'rgba(0, 149, 255, 0.6)' ],
			hoverBackgroundColor: [ 'rgba(0, 149, 255, 0.6)', 'rgba(0, 149, 255, 0.6)', 'rgba(0, 149, 255, 0.6)', 'rgba(0, 149, 255, 0.6)', 'rgba(0, 149, 255, 0.6)' ]
		},
		{
